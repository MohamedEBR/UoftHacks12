  ...
  return (
    <Card className="mb-3 shadow-sm">
      ...
      <Card.Footer className="text-muted d-flex justify-content-between align-items-center">
        <div>
          <Button variant="outline-primary" size="sm" onClick={() => handleLike(post._id)}>Like</Button>{' '}
          <Button variant="outline-secondary" size="sm" onClick={handleCommentClick}>Comment</Button>
        ...
        <Card.Footer>
          <Form onSubmit={handleCommentSubmit}>
            ...
            <div className="text-end mt-2">
              <Button variant="primary" type="submit" size="sm">Post Comment</Button>
            </div>
          </Form>
        </Card.Footer>
      )}
      {loadingComments && <Card.Footer>Loading comments...</Card.Footer>}
      {errorComments && <Card.Footer>Error loading comments: {errorComments}</Card.Footer>}
      {comments.length > 0 && (
        <Card.Footer>
